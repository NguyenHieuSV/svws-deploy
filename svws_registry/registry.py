...
def ai_baso(payload: dict = Body(...)):
    ...
    sys_msg = (
        ...
        "pump · dosing (cụm châm hoá chất) · roskid · edi · uv · panel\n"
        ...
        "   kW, kieuDien (DOL|VFD) · cho thiết bị có động cơ (pump, dosing). Thiết "
        "bị ăn điện mà không có động cơ (phanung qua tủ chỉnh lưu, uv qua chấn "
        "lưu) thì khai kW và bỏ trống kieuDien\n"
